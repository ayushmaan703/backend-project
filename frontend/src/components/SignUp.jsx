        ...
        <div className="flex flex-col space-y-2 justify-center items-center border border-slate-600 p-3">
          ...
          >
            <div className="w-full relative h-28 bg-[#222222]">
              <div className="w-full h-full">
                <GetImagePreview
                  ...
                  cameraIcon={true}
                />
                <div className="text-sm absolute right-2 bottom-2 hover:text-cyan-500 cursor-default">
                  cover Image
                </div>
              </div>
            ...
            <Button
              type="submit"
              bgColor="bg-cyan-500"
              className="w-full sm:py-3 py-2 hover:bg-cyan-700 text-lg"
            >
              Signup
            </Button>
            ...
            <p className="text-center text-sm">
              ...
              <Link
                to={"/login"}
                className="text-cyan-600 cursor-pointer hover:opacity-70"
              >
                Login
              </Link>
            </p>
